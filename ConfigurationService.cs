...
public class ConfigurationService
{
    ...
    private ConfigurationService()
    {
        ...
        YoutubeConfigs = LoadYoutubeConfigs();
    }
    ...
    public List<SocketTextChannel> ReactionFilterChannels => ReactionFilterChannelIds.Split(',')
    ...
    {
        var configs = new List<YoutubeConfig>();
        var i = 1;
        while (true)
        {
